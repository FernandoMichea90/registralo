        ...
        <Stack spacing={3} sx={{ px: 2.5, pt: 3, pb: 5 }}>
          ...
          <Stack direction="row">
            ...
            <Stack direction="row" flexWrap="wrap" alignItems="center">
              ...
              <KanbanContactsDialog assignee={task.assignee} open={openContacts} onClose={handleCloseContacts} />
            </Stack>
          </Stack>
          ...
          <Stack direction="row" alignItems="center">
            ...
            <KanbanDetailsPrioritizes prioritize={prioritize} onChangePrioritize={handleChangePrioritize} />
          </Stack>
