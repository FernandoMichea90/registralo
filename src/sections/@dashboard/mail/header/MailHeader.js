...
// @mui
import { Box, Stack, Tooltip, Checkbox, Typography, IconButton, InputAdornment, TextField } from '@mui/material';
// hooks
        ...
        {smUp && (
          <>
            <Checkbox
              ...
              onChange={(event) => (event.target.checked ? onSelectAllMails() : onDeselectAllMails())}
            />
