  ...
  return (
    <Stack spacing={3}>
      ...
      <div>
        ...
        <Paper variant="outlined" sx={style}>
          <Chip disabled variant={variant} avatar={<Avatar>M</Avatar>} label="Disabled" onDelete={handleDelete} />
      ...
      <div>
        ...
        <Paper variant="outlined" sx={style}>
          <Chip variant={variant} avatar={<Avatar>M</Avatar>} label="Normal" onDelete={handleDelete} color="info" />
