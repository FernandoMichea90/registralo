...
const MapMarkersPopups = dynamic(() => import('../../../sections/_examples/extra/map/MapMarkersPopups'));
const MapDraggableMarkers = dynamic(() => import('../../../sections/_examples/extra/map/draggable-markers'));
const MapGeoJSONAnimation = dynamic(() => import('../../../sections/_examples/extra/map/MapGeoJSONAnimation'));
const MapViewportAnimation = dynamic(() => import('../../../sections/_examples/extra/map/viewport-animation'));
const MapHighlightByFilter = dynamic(() => import('../../../sections/_examples/extra/map/MapHighlightByFilter'));
